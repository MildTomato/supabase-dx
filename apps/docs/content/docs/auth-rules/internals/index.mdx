...
This section explains how Auth Rules works under the hood. You don't need to
understand these details to use Auth Rules, but they're helpful for debugging,

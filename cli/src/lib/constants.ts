...
export type Region = 
  ...
  | 'ap-east-1' | 'ap-southeast-1' | 'ap-northeast-1' | 'ap-northeast-2' | 'ap-southeast-2' 
  | 'eu-west-1' | 'eu-west-2' | 'eu-west-3' | 'eu-north-1' | 'eu-central-1' | 'eu-central-2' 
  | 'ca-central-1' | 'ap-south-1' | 'sa-east-1';
...
export const REGIONS: Array<{ key: string; label: string; value: Region }> = [
  ...
  { key: 'ap-southeast-1', label: 'Asia Pacific (Singapore)', value: 'ap-southeast-1' },
  { key: 'ap-southeast-2', label: 'Asia Pacific (Sydney)', value: 'ap-southeast-2' },
  { key: 'ap-northeast-1', label: 'Asia Pacific (Tokyo)', value: 'ap-northeast-1' },
  { key: 'ap-northeast-2', label: 'Asia Pacific (Seoul)', value: 'ap-northeast-2' },
